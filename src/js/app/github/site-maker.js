class SiteMaker { // GitHub Pages で稼働するようファイル作成する（git push するファイルを作る）
    ...
    async make() { // 初回にリモートリポジトリを作成するとき一緒に作成する
        //await window.myApi.cp(`src/lib/toastify/1.11.2/min.css`, `dst/${this.setting.github.repo}/lib/toastify/1.11.2/min.css`)
        //window.myApi.cp(`lib/toastify/1.11.2/min.css`, `min.css`)
        //await window.myApi.cp(`README.md`, `a.md`)
